...
-->
	...
	<body>
		<form method="post" name="form1" id="form2"	action="/back/admin!ModifyAdmins.action" onSubmit="return checkForm()">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="0"	align="center">
							...
							<tr>
								<td colspan="5">
									...
									<input type="hidden" id="aid" name="aid" value="${admins.aid}" />
									<table width="65%" border="0" align="center" cellpadding="0" cellspacing="1">
										...
										<tr>
											...
											<td width="65%" height="35"	background="/back/images/b_table_header.gif">
												<input type="text" id="acount" name="acount"	value="${admins.acount }" />
											</td>
										</tr>
										<tr>
											<td width="35%" height="35" align="right"	background="/back/images/b_table_header.gif">
											...
											<td width="65%" height="35"		background="/back/images/b_table_header.gif">
												<input type="password" id="apwd" name="apwd"	value="${admins.apwd }" />
											</td>
										</tr>
										<tr>
											<td width="35%" height="35" align="right"	background="/back/images/b_table_header.gif">
											...
											<td width="65%" height="35"		background="/back/images/b_table_header.gif">
												<select name="pcid" >               	  	  
							               	  	   <c:forEach items="${sessionScope.PermissionList}" var="adm" varStatus="su">
							               	  	      <c:if test="${admins.permission.perid == adm.perid}">
							               	  	         <option value="${adm.perid}" selected="selected">${adm.pername}</option>
							               	  	      </c:if>
							               	  	      <c:if test="${admins.permission.perid != adm.perid}">
